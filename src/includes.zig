...
pub const __LDBL_REDIR2_DECL = @compileError("unable to translate C expr: unexpected token Id{ .Nl = void }");
...
pub const __attr_access = @compileError("unable to translate C expr: unexpected token Id{ .Nl = void }");
...
pub const APIENTRYP = @compileError("unable to translate C expr: unexpected token Id{ .Nl = void }");
pub const GLAPIENTRYP = @compileError("unable to translate C expr: unexpected token Id{ .Nl = void }");
